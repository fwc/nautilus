...
val<unsigned long long int> test(val<unsigned char> var_1, val<unsigned int> var_3, val<unsigned int> var_4, val<long long int> var_7, val<int> _, val<unsigned short> var_10, val<int> var_11) {
    ...
    val<unsigned long long int> seed = 0;
...
int main(int, char* []) {
	...
	auto result = function((unsigned char)170, 847848521U, 4131743101U, 5651007851781001195LL, 0, (unsigned short)42617, 1929698655);
