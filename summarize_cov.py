...
def summarize_file(arg):
    ...
    tests_executed = None
    if "-" in arg:
        tests_executed = int(arg.split("-")[0])
    ...
    return tests_executed, lines_cov / lines_tot, funct_cov / funct_tot, brnch_cov / brnch_tot
...
def main():
    ...
    _, ts_lines, ts_funct, ts_brnch = summarize_file(sys.argv[2])
