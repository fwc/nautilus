...
Seed: 3688
Invocation: /home/mgoerdel/inspos/yarpgen/build/yarpgen --nautilus=true --use-compilation=false --seed=3688
*/
...
void test(val<int> zero, val<unsigned char*> var_20, val<signed char*> var_21) {
    ...
    *var_21 = ((/* implicit */val<signed char>) ((val<unsigned int>) 0U));
}
